# functiuons = A block of reusable code
#              plaec () after the funcation name to invoke it

def happy_birthday(name,age):
    print(f"Happy Birthday too {name}!")
    print(f"You are {age} years old!")
    print("Happy Birthday too you!")
...
print(add(1,2))  # This function become 3 because it becomes what it is returned
print(subtract(1,2))
print(multiply(1,2))
print(divide(1,2))
